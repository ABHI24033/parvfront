...
const VehicleLoanDocuments = ({id,employment_type}) => {
    ...
    const handleClick = async (e) => {
        ...
        try {
            ...
            const response2 = await axios.put(`${backendUrl}/update_vehicle_doc/${id}`,
                newformData,
                {
                    headers: {
    ...
    return (
        <div className='container my-4'>
            ...
            <button className='btn btn-primary' onClick={handleClick} disabled={progress?true:false}>
