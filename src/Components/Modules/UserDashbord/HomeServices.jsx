...
const HomeServices = () => {
  ...
  const getAllProfessionalForms = async () => {
    try {
      ...
      const response = await fetch(
        ...
        `${backendUrl}/getAllProfessionalForms/${userID}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  //   try {
  //     const response = await fetch(
  //       `${backendUrl}/getAllCarLoanForms/${userID}`,
  //       {
  //         method: "GET",
  //         headers: {
  //           "Content-Type": "application/json",
            ...
            <div className="col-md-4 mb-4">
              <div className="border border-secondary rounded p-3">
                ...
                <Link to='/homeservices/formTable/getAllBusinessLoanForms'>
                  {/* <button className="homeServices px-4">Total Applicants : {businessforms?.length}</button> */}
                  <button className="homeServices px-4">Applications </button>
                </Link>
