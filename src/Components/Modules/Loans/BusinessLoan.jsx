...
const BusinessLoan = () => {
  ...
  const handleClick = async (e) => {
    ...
    const object = { dividendArr, dividendArr1, dividendArr2, dividendArr3, dividendArr4, dividendArr5, dividendArr6, formData, loanType: "BusinessLoan", connector_id: userId }
    console.log(object);
