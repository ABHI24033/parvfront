...
const HomeLoanForm = ({ getID }) => {
    ...
    console.log(formData?.employment_type);
                    ...
                    <div className="mb-2">
                        <div className="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                            <div className="mb-4 text-center">
                                <h1 className="mb-0">Home Loan Application Form </h1>
                            </div>
                        </div>
                        <form>
                            <div>
                                        ...
                                        <>
                                            ...
                                            <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                                <div className="mb-3">
                                                    ...
                                                    />
                                                    {
                                                        errors?.firm_name && <p className="fs-6 text-danger">{errors?.firm_name}</p>
                                                    }
                                                </div>
                                            </div>
                                            <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
